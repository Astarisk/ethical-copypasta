...
public class MultiSession {
	...
	public static void setActiveSession(UI ui) {
		if(ui.sess != null)
			MainFrame.mf.setTitle("Haven and Hearth \u2013 Ethically-Sourced-CopyPasta " + Config.version + " \u2013 " + ui.sess.username);
		else
			MainFrame.mf.setTitle("Haven and Hearth \u2013 Ethically-Sourced-CopyPasta "+ Config.version);
