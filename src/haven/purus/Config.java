...
public class Config {
	...
	public static Setting<Boolean> reverseBadCamX = new Setting<>("reverseBadCamX", true);
	public static Setting<Boolean> reverseBadCamY = new Setting<>("reverseBadCamY", true);
